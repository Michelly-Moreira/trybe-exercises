/* Qual é a ordem de finalização de execução das linhas comentadas?
...
const sendMarsTemperature = () => {
  const inputMessage = getMarsTemperature();
  setTimeout(() => {
    console.log(`A temperatura de Marte é: ${inputMessage} graus celsius`)
  }, messageDelay());
};
...
/* 
vamos utilizar essa temperatura para realizar outras operações. No código abaixo, temos as funções temperatureInFahrenheit e greet. Elas irão utilizar a temperatura obtida pela função getMarsTemperature para realizar nossas operações. Escreva a função sendMarsTemperature de forma que:
